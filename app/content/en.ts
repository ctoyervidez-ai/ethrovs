...
const en: SiteCopy = {
  ...
  pricing: {
    label: "Three packages",
    title: "Pick where your business",
    titleAccent: "lands.",
    cta: "Book it",
    tiers: {
      express: {
        name: "Express",
        for: "The business that needs to exist online now",
        items: ["One page, up to six sections, custom design", "Mobile version, call, map and WhatsApp", "Basic SEO and your domain connected", "One round of changes"],
        when: "Delivered in 24 h",
        whatsappMessage: "Hi ETHROVS, I'm interested in the 24 h Express package",
      },
      completo: {
        name: "Complete",
        for: "A restaurant, clinic or firm that has outgrown one page",
        items: ["Up to twelve sections or several pages", "Bilingual version included, not an add-on", "Google Business profile set up", "Two rounds of changes"],
        when: "Delivered in 3 to 5 days",
        whatsappMessage: "Hi ETHROVS, I'm interested in the Complete package",
      },
      tienda: {
        name: "Store",
        for: "A brand selling products that wants to charge online",
        items: ["Shopify store themed to your brand", "Up to 25 products loaded with photos", "Card, Mercado Pago and OXXO payments", "Shipping, zones and taxes configured", "One hour of training so you can run it"],
        when: "Delivered in 5 to 7 days",
        whatsappMessage: "Hi ETHROVS, I'm interested in the online Store package",
      },
    },
    ...
    care: {
      title: "Care plan",
      per: "per month",
      text: "Hosting, domain, backups and up to thirty minutes of small changes each month. No lock-in.",
    },
    extrasTitle: "Charged separately",
    extrasText: "Charged once and added to the total before we start.",
    extras: ["Bilingual version on the Express package", "Additional product in the store, past 25", "Additional page", "Extra round of changes"],
  },
  faq: {
